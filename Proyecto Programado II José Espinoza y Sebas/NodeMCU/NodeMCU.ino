    ...
    */
    if (del2puntos > 0) {
      ...
      *output = getSense();
      ...
      digitalWrite(In3,1);
      digitalWrite(In4,0);
      digitalWrite(In1,1); // movimiento hacia adelante
      digitalWrite(In2,0);
      delay(8500);
      analogWrite(EnA,0);
      digitalWrite(EnB,0);
      
    }else if(comando == "inifinte"){
      digitalWrite(In1,1);// movimeinto hacia adelante
      digitalWrite(In2,0);
      analogWrite(EnA,1023);// Potencia 
      digitalWrite(EnB,1);
      digitalWrite(In3,1);//dirección, primera parte del infinito 
      digitalWrite(In4,0);
      delay(8500);
      digitalWrite(In3,0); //cambio de dirección en la segunda parte del infinito 
      digitalWrite(In4,1);
      delay(8500);
      analogWrite(EnA,0);// quitar alimentación 
      
    }else if( comando == "zigzag"){
      digitalWrite(In1,0);//movimeinto hacia adelante
      digitalWrite(In2,1);
      analogWrite(EnA, 1023);//potencia 
      digitalWrite(EnB,1);
      digitalWrite(In3,1);//dirección a la izquierda
      digitalWrite(In4,0);
      delay(2000);
      digitalWrite(In3,0);//dirección a la derecha
      digitalWrite(In4,1);
      delay(2000);
      digitalWrite(In3,1);
      digitalWrite(In4,0);//dirección a la izquierda
      delay(2000);
      digitalWrite(In3,1);//dirección a la derecha
      digitalWrite(In4,0);
      analogWrite(EnA,0); // corto alimentacíon
      digitalWrite(EnB,0);
    }else if(comando = "8reversa"){  //movimiento especial
      digitalWrite(In1,0);// movimeinto hacia atras
      digitalWrite(In2,1);
      analogWrite(EnA,1023);// Potencia 
      digitalWrite(EnB,1);
      digitalWrite(In3,1);//dirección, primera parte del infinito 
    ...
    switch (llave[1]) {
      ...
      case 'r':
       ...
       case 'o':
        ...
        break;
       case 'e':
        Serial.println("Encender todas la luces");
        if(valor == "1"){
          data = B00000000;
        }
        break;
